...
export const setting = sqliteTable('setting', {
	...
	smtpEnableStarttls: integer('smtp_enable_starttls').default(0).notNull(),
	smtpTlsKeyPath: text('smtp_tls_key_path').default('').notNull(),
	smtpTlsCertPath: text('smtp_tls_cert_path').default('').notNull(),
	smtpSecureEnabled: integer('smtp_secure_enabled').default(0).notNull(),
	smtpSecurePort: integer('smtp_secure_port').default(465).notNull(),
