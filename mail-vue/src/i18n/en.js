const en = {
    ...
    emailSuffixManage: 'Email Suffix Management',
    emailSuffixList: 'Mailbox List',
    emailSuffixPageDesc: 'Manage available email suffixes from this standalone sidebar page.',
    reload: 'Reload',
    batchImport: 'Batch Import',
    batchImportDomains: 'Batch Add Suffixes',
    domainBatchInputPlaceholder: 'Supports line breaks, spaces, commas, or Chinese commas. Example:\\nmail.com\\n*.corp.cn',
    deleteSelected: 'Delete Selected',
    domainListEmptyMsg: 'Email suffix list cannot be empty',
    invalidDomainMsg: 'Invalid email suffix format, supports *.example.com',
    duplicateDomainMsg: 'Email suffixes cannot be duplicated',
    ...
    resendToken: 'Server Sending',
    smtpSubmission: 'SMTP Submission',
    smtpSubmissionDesc: 'Expose this server to other systems as an SMTP sending endpoint; authenticated clients can relay to external domains',
    smtpRequireAuth: 'Require Authentication',
    smtpAuthUser: 'SMTP Username',
    smtpAuthPass: 'SMTP Password',
    smtpAuthPassPlaceholder: 'Leave blank to keep the current password',
    smtpEnableStarttls: 'Enable STARTTLS',
    smtpTlsKeyPath: 'TLS Private Key Path',
    smtpTlsCertPath: 'TLS Certificate Path',
    smtpSecureEnabled: 'Enable SMTPS',
    smtpSecurePort: 'SMTPS Port',
    smtpPlainFallback: 'Plain AUTH fallback',
    smtpRestartHint: 'Host and port are still controlled by environment variables; saved auth/TLS settings will hot-reload',
    permanentToken: 'Permanent Token',
    permanentTokenDesc: 'Stable token for public API access across multiple programs',
    editPermanentToken: 'Edit Permanent Token',
    permanentTokenPlaceholder: 'Leave blank to clear the permanent token',
    batchUserDefaultPassword: 'Batch User Default Password',
    batchUserDefaultPasswordDesc: 'Default login password for batch-created pickup URL users',
    batchUserDefaultPasswordPlaceholder: 'Leave blank to keep the current default password',
    oss: 'Object Storage',
    osDomain: 'Domain',
    ...
    addResendTokenDesc: 'Server direct SMTP is enabled; no token required',
    ...
    resendTokenList: 'Sending Mode',
    smtpServerSend: 'Server direct MX (no token)',
    domain: 'Domain',
    optional: 'Optional',
    ...
    batchCreatePickupUrl: 'Batch Create Pickup URLs',
    ...
    pickupOutputMode: 'Output format',
    pickupOutputList: 'Mail list',
    pickupOutputLatestBody: 'Latest message body',
