const zh = {
    ...
    emailSuffixManage: '邮箱后缀管理',
    emailSuffixList: '邮箱列表',
    emailSuffixPageDesc: '在这里统一管理可用邮箱后缀，左侧单独入口直接维护。',
    reload: '刷新',
    batchImport: '批量导入',
    batchImportDomains: '批量添加后缀',
    domainBatchInputPlaceholder: '支持换行、空格、英文逗号、中文逗号分隔，例如：\\nmail.com\\n*.corp.cn',
    deleteSelected: '删除选中',
    domainListEmptyMsg: '邮箱后缀不能为空',
    invalidDomainMsg: '邮箱后缀格式不正确，支持 *.example.com',
    duplicateDomainMsg: '邮箱后缀不能重复',
    customization: '个性化设置',
    websiteTitle: '网站标题',
    ...
    sendEmail: '邮件发送',
    resendToken: '服务器发件',
    smtpSubmission: 'SMTP 提交',
    smtpSubmissionDesc: '给其他系统作为 SMTP 发信入口使用；认证后可转发到站外域名',
    smtpRequireAuth: '要求认证',
    smtpAuthUser: 'SMTP 用户名',
    smtpAuthPass: 'SMTP 密码',
    smtpAuthPassPlaceholder: '留空则保持当前密码',
    smtpEnableStarttls: '启用 STARTTLS',
    smtpTlsKeyPath: 'TLS 私钥路径',
    smtpTlsCertPath: 'TLS 证书路径',
    smtpSecureEnabled: '启用 SMTPS',
    smtpSecurePort: 'SMTPS 端口',
    smtpPlainFallback: '明文认证兼容',
    smtpRestartHint: '监听地址和端口仍由环境变量控制；其余认证/TLS 设置保存后会热刷新',
    permanentToken: '永久 Token',
    permanentTokenDesc: '供多程序稳定调用公开接口，不会被动态 token 顶掉',
    editPermanentToken: '编辑永久 Token',
    permanentTokenPlaceholder: '留空可清除永久 Token',
    batchUserDefaultPassword: '批量用户默认密码',
    batchUserDefaultPasswordDesc: '批量创建用户取件URL时使用的默认登录密码',
    batchUserDefaultPasswordPlaceholder: '留空则保持当前默认密码',
    oss: '对象存储',
    osDomain: '访问域名',
    ...
    community: '交流',
    changeTitle: '修改标题',
    addResendTokenDesc: '已改为服务器 SMTP 直发，无需配置',
    addOsDomain: '添加域名',
    domainDesc: '域名',
    ...
    resendTokenList: '发件方式',
    smtpServerSend: '服务器直连 MX（无需 Token）',
    domain: '域名',
    optional: '可选',
    ...
    batchCreatePickupUrl: '批量创建用户取件URL',
    pickupMailbox: '取件邮箱',
    pickupEmailInputPlaceholder: '输入邮箱，支持换行、空格、逗号、分号分隔',
    pickupExpireDays: '有效天数（0=永久）',
    neverExpire: '永久有效',
    generatePickupUrl: '生成取件URL',
    pickupOutputMode: '导出格式',
    pickupOutputList: '邮件列表',
    pickupOutputLatestBody: '最新一封正文',
    exportTxt: '导出TXT',
